    ...
    <div className="min-h-screen bg-gray-900 py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gray-800 rounded-lg shadow-md p-8 mb-8">
            <h2 className="text-2xl font-semibold mb-6 text-white">Our Approach</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Evidence-Based</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Privacy-Focused</h3>
                <p className="text-gray-400">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold mb-2 text-white">Compassionate</h3>
                <p className="text-gray-400">
          ...
          <div className="bg-gray-800 rounded-lg shadow-md p-8">
            <h2 className="text-2xl font-semibold mb-4 text-white">AI-Powered Analysis</h2>
            <p className="text-gray-300 mb-4">
